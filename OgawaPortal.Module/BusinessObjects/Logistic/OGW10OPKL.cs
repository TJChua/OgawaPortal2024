...
namespace OgawaPortal.Module.BusinessObjects.Logistic
{
    ...
    [Appearance("HideOPKLCopyFrmDR", AppearanceItemType = "Action", TargetItems = "CopyFrmDR", Criteria = "IsNew or Status.Code != 'DRAFT'", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    public class OGW10OPKL : XPObject
    { 
        public OGW10OPKL(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            ObjType = Session.FindObject<vwObjType>(CriteriaOperator.Parse("Code = 'OGW10OPKL'"));
        ...
        [Association("OGW10OPKL-OGW11OPKL")]
        [XafDisplayName("Items")]
        public XPCollection<OGW11OPKL> OGW11OPKL
        {
            get { return GetCollection<OGW11OPKL>("OGW11OPKL"); }
        }

        [Association("OGW10OPKL-OGW13OPKL")]
        [XafDisplayName("Attachments")]
        public XPCollection<OGW13OPKL> OGW13OPKL
        {
            get { return GetCollection<OGW13OPKL>("OGW13OPKL"); }
        }

        [Association("OGW10OPKL-OGW15OPKL")]
        [XafDisplayName("Document Status")]
        public XPCollection<OGW15OPKL> OGW15OPKL
        {
            get { return GetCollection<OGW15OPKL>("OGW15OPKL"); }
        }
