...
namespace OgawaPortal.Module.BusinessObjects.POS___Logistic
{
    ...
    public class OGW10DREX : XPObject
    { 
        public OGW10DREX(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            DeliveryRequestDate = DateTime.Today;

            ObjType = Session.FindObject<vwObjType>(CriteriaOperator.Parse("Code = 'OGW10DREX'"));
        ...
        [Association("OGW10DREX-OGW11DREX")]
        [XafDisplayName("Items")]
        public XPCollection<OGW11DREX> OGW11DREX
        {
            get { return GetCollection<OGW11DREX>("OGW11DREX"); }
        }

        [Association("OGW10DREX-OGW12DREX")]
        [XafDisplayName("Payment")]
        public XPCollection<OGW12DREX> OGW12DREX
        {
            get { return GetCollection<OGW12DREX>("OGW12DREX"); }
        }

        [Association("OGW10DREX-OGW15DREX")]
        [XafDisplayName("Document Status")]
        public XPCollection<OGW15DREX> OGW15DREX
        {
            get { return GetCollection<OGW15DREX>("OGW15DREX"); }
        }
